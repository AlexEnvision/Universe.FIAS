...
namespace Universe.Fias.XML.GAR.Converter.x64.Algorithms.AddressSystem.Loader
{
    ...
    public class AddrSysDownloader : DisposableObject
    {
                        ...
                        .ForEach(
                            _ => oper.AddVersion(
                                new AsVersion {
                                    ...
                                    FiasFullDbfUrl = _.GarXMLFullURL,
                                    FiasDeltaDbfUrl = _.GarXMLDeltaURL,
        ...
        /// </exception>
        public DownloadFileInfo GetLastVersionFromWeb()
        {
        ...
        private async Task StartDownloadAsync(AsVersion versionForDownload)
        {
            ...
            try
            {
                urlForDownload = versionForDownload.IsDownloadedFiasFullXml != null
                    ? versionForDownload.FiasFullDbfUrl
                    : (versionForDownload.IsDownloadedFiasDeltaXml != null
        ...
        /// <param name="args">The <see cref="System.Net.DownloadProgressChangedEventArgs"/> instance containing the event data.</param>
