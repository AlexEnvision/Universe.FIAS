...
{
    /// <summary>
    ///     Режимы сопоставления названий улиц
    /// </summary>
    public enum StreetMatchMode
    {
        /// <summary>
        ///     Пытатся точно сопоставить родительский объект для улицы в виде кодов города или населённого рункта.
